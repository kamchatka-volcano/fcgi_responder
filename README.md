...
Input data inside `/fuzz_tests/input` is generated by `fuzz_input_generator` utility. It's a modified version of unit tests, writing input data to files. To build it, use the following commands:
```
cd fcgi_responder
