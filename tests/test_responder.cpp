...
TEST_F(TestResponder, UnknownType)
{
    ...
    encoder << hardcoded::protocolVersion << static_cast<std::uint8_t>(99) << static_cast<std::uint16_t>(1)
...
TEST_P(TestResponder, RecordReadError)
{
    ...
    encoder << hardcoded::protocolVersion << static_cast<std::uint8_t>(RecordType::GetValues) << static_cast<std::uint16_t>(1)
            << static_cast<std::uint16_t>(nameValue.size()) << static_cast<std::uint8_t>(0);
    encoder.addPadding(1);
